export const newsList = [
  ...
  },
  {
    ...
    content: `
      ...
      Selain fokus pada pengembangan kapasitas SDM pemuda, kolaborasi ini juga menyoroti implementasi green waqf (wakaf hijau) dan teknologi digital untuk transparansi pengelolaan dana publik. FWP berkomitmen memfasilitasi inkubasi bisnis bagi startup pemuda berbasis wakaf, guna mendorong ekosistem kewirausahaan sosial yang mandiri.

      Langkah ini mendapat apresiasi luas dari delegasi negara-negara anggota D-8 Halal Expo 2026 yang melihat model integrasi wakaf produktif dan pemberdayaan pemuda di Indonesia sebagai referensi global yang sangat aplikatif untuk diterapkan di negara berkembang lainnya.
    `,
    mediaCoverage: [
      { media: 'TV One News', url: 'https://www.tvonenews.com/ekonomi/453724-mengenal-wakaf-produktif-plus-pengembangan-talenta-muda-sebagai-strategi-jitu-lawan-kemiskinan?page=all' },
      { media: 'Indonesia Window (ID)', url: 'https://indonesiawindow.com/fokus-berita-forum-wakaf-produktif-dan-oic-youth-indonesia-dorong-kolaborasi-talenta-inovasi-berkelanjutan' },
      { media: 'Indonesia Window (EN)', url: 'https://indonesiawindow.com/news-focus-productive-waqf-forum-and-oic-youth-indonesia-encourage-talent-collaboration-and-sustainable-innovation' },
      { media: 'Faktanesia.id', url: 'https://faktanesia.id/forum-wakaf-produktif-dorong-keuangan-berbasis-nilai-keagamaan-siapkan-mesin-baru-pembangunan/' },
      { media: 'Humaniora.id (EN)', url: 'https://www.humaniora.id/forum-wakaf-produktif-and-oic-youth-indonesia-advance-collaboration-on-talent-sustainable-innovation-and-faith-based-finance-at-the-d-8-halal-expo-indonesia-2026/' },
      { media: 'Humaniora.id (ID)', url: 'https://www.humaniora.id/indonesia-dorong-kolaborasi-talenta-inovasi-berkelanjutan-dan-keuangan-berbasis-nilai-keagamaan-sebagai-motor-baru-pembangunan-di-d-8-halal-expo-2026/' },
      { media: 'Mozaik Inilah', url: 'https://mozaik.inilah.com/news/wakaf-produktif-jadi-senjata-baru-bangun-ekonomi-umat' },
      { media: 'OIC Youth Indonesia (ID)', url: 'https://oicyouthindonesia.org/forum-wakaf-produktif-dan-oic-youth-indonesia-dorong-kolaborasi-talenta-inovasi-berkelanjutan-dan-keuangan-berbasis-nilai-keagamaan-pada-d-8-halal-expo-indonesia-2026/' },
      { media: 'OIC Youth Indonesia (EN)', url: 'https://oicyouthindonesia.org/forum-wakaf-produktif-and-oic-youth-indonesia-advance-collaboration-on-talent-sustainable-innovation-and-faith-based-finance-at-the-d-8-halal-expo-indonesia-2026/' }
    ]
  },
  {
    id: 'wls-2026-pendaftaran-ditutup',
    title: 'Resmi Ditutup! Pendaftaran Waqf Leaders Summit 2026 Capai Target 53 Peserta Nasional',
    date: '21 Juli 2026',
    author: 'Panitia WLS 2026',
    category: 'Event & Summit',
    ...
    excerpt: 'Pendaftaran Waqf Leaders Summit 2026 resmi ditutup dengan total 53 peserta dari berbagai lembaga nazhir, regulator, dan BSI. Seluruh persiapan teknis dan pembagian kamar delegasi telah rampung.',
    content: `
      BANDUNG — Pendaftaran resmi untuk perhelatan akbar Waqf Leaders Summit (WLS) 2026 secara resmi telah ditutup per hari ini, Selasa, 21 Juli 2026. Panitia mencatat total delegasi yang terdaftar mencapai 53 peserta dari berbagai lembaga nazhir nasional, institusi pemerintah, akademisi, serta 2 perwakilan dari mitra strategis Bank Syariah Indonesia (BSI).

      Sekretaris Panitia WLS 2026, Ridlo Abelian, menyampaikan bahwa kuota peserta telah terpenuhi sesuai dengan proyeksi daya tampung ballroom utama Granada di Holiday Inn Pasteur Bandung. Seluruh persiapan logistik, mulai dari pembagian kamar penginapan bintang 4 untuk delegasi hingga penyediaan fasilitas seminar kit, saat ini sudah 100% rampung.

      "Alhamdulillah, antusiasme dari para pimpinan lembaga nazhir sangat luar biasa. Target awal kami 50 peserta telah terlampaui dengan total 53 pendaftar terkunci. Kami juga telah menyelesaikan skema pembagian kamar bagi peserta luar kota agar proses check-in besok berjalan tertib dan cepat," ujar Ridlo.

      WLS 2026 yang akan berlangsung selama dua hari penuh pada 22–23 Juli 2026 ini mengusung tema "Scale Up Waqf: Visionary Collaboration and Disruptive Innovation for Sustainable Economic Growth". Selain dihadiri pimpinan FWP dan stakeholder ekosistem wakaf nasional, forum ini juga mengamankan kehadiran Kyai Miftah Faridh secara langsung untuk memberikan refleksi rohani serta meresmikan peluncuran Unit Manajemen Investasi (UMI) FWP.

      Bagi peserta dan panitia, dresscode resmi untuk hari pertama telah ditetapkan seragam kemeja putih dengan peci hitam (untuk pria) pada sesi pagi hingga sore, dilanjutkan dengan batik pada gala dinner malam hari. Sementara hari kedua akan menggunakan pakaian bebas rapi yang dilengkapi dengan jaket resmi WLS 2026.
    `,
    mediaCoverage: []
  }
];
