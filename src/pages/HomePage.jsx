    ...
    <>
          ...
          <div className="hero-grid" style={{ display: 'grid', gridTemplateColumns: '1.2fr 0.8fr', gap: '60px', alignItems: 'center', width: '100%' }}>
            ...
            >
              <motion.h1 className="hero-title" variants={fadeInUp} style={{ fontSize: '3.8rem', lineHeight: '1.15', marginBottom: '24px' }}>
                Transformasi Wakaf Nasional Menuju Indonesia Emas 2045
              </motion.h1>
              <motion.p className="hero-subtitle" variants={fadeInUp} style={{ marginLeft: 0, fontSize: '1.2rem', maxWidth: '600px', marginBottom: '40px' }}>
                Forum Wakaf Produktif (FWP) memimpin Gerakan Indonesia Berwakaf.
                Bersama-sama kita wujudkan kolaborasi antar Lembaga Nazhir untuk memajukan ekosistem wakaf produktif di Indonesia.
              </motion.p>
        ...
        <div className="container grid-2">
          ...
          >
            ...
            <motion.p style={{ fontSize: '1.1rem', color: 'var(--text-main)', marginBottom: '24px' }} variants={fadeInUp}>
              Diinisiasi untuk memperkuat gerakan wakaf di tingkat nasional, FWP menjadi ruang bertukar informasi, menjalin komunikasi, serta meningkatkan kompetensi para pengelola (Lembaga Nazhir) wakaf agar semakin masif dan berdampak luas.
            </motion.p>
            <motion.ul style={{ listStyle: 'none', display: 'flex', flexDirection: 'column', gap: '16px' }} variants={staggerContainer}>
              <motion.li style={{ display: 'flex', alignItems: 'flex-start', gap: '12px' }} variants={fadeInUp}>
                <div style={{ padding: '8px', background: 'var(--secondary-color)', color: 'white', borderRadius: '50%' }}>
                  <Users size={20} />
                </div>
                <div>
                  <h4 style={{ margin: 0, color: 'var(--text-main)', fontSize: '1.2rem' }}>Sinergi Lembaga Nazhir</h4>
                  <p style={{ margin: 0, fontSize: '0.95rem' }}>Membangun kolaborasi antar Lembaga Nazhir untuk proyek wakaf skala besar.</p>
                </div>
              </motion.li>
              <motion.li style={{ display: 'flex', alignItems: 'flex-start', gap: '12px' }} variants={fadeInUp}>
                ...
                <div>
                  <h4 style={{ margin: 0, color: 'var(--text-main)', fontSize: '1.2rem' }}>Profesionalisme</h4>
                  <p style={{ margin: 0, fontSize: '0.95rem' }}>Meningkatkan tata kelola dan kompetensi Lembaga Nazhir sesuai standar BWI.</p>
                </div>
              </motion.li>
            </motion.ul>
          </motion.div>
        ...
        <div className="container">
          ...
          >
            <motion.div className="glass-card" variants={fadeInUp} whileHover={{ y: -8, scale: 1.02 }}>
              ...
              <p>Meningkatkan pemahaman masyarakat tentang konsep wakaf produktif agar terjangkau semua kalangan.</p>
            </motion.div>
            ...
            <motion.div className="glass-card" variants={fadeInUp} whileHover={{ y: -8, scale: 1.02 }}>
              ...
              <h3>Rembuk & Munas</h3>
              <p>Mengadakan Musyawarah Nasional dan Rakernas rutin untuk merumuskan kebijakan stategis.</p>
            </motion.div>
            ...
            <motion.div className="glass-card" variants={fadeInUp} whileHover={{ y: -8, scale: 1.02 }}>
              ...
              <h3>Kemitraan Regulator</h3>
              <p>Menjadi mitra strategis BWI, Kemenag, BI, dan OJK dalam mendorong kemudahan regulasi.</p>
            </motion.div>
          </motion.div>
        </div>
      </section>
      ...
      <section className="section section-bg" id="nazhir">
        <div className="container text-center">
          ...
          >
            Bersama Puluhan Lembaga Nazhir Terpercaya
          </motion.h2>
          <motion.p 
            style={{ maxWidth: '600px', margin: '0 auto', marginBottom: '40px' }}
            initial="hidden" whileInView="visible" viewport={{ once: true }} variants={fadeInUp}
          >
            Forum Wakaf Produktif beranggotakan berbagai Lembaga Nazhir profesional yang terdaftar resmi di Badan Wakaf Indonesia (BWI).
          </motion.p>
          ...
          <motion.div 
            ...
            initial="hidden" whileInView="visible" viewport={{ once: true }} variants={fadeInUp}
          >
            <motion.a href="mailto:registrasi@fwp.or.id" className="btn btn-secondary" whileHover={{ scale: 1.05 }} whileTap={{ scale: 0.95 }}>
