    ...
    <footer className="footer" id="kontak" style={{ background: 'var(--primary-color)', color: 'var(--text-light)', paddingTop: '64px' }}>
      <div className="container" style={{ display: 'grid', gridTemplateColumns: 'repeat(auto-fit, minmax(250px, 1fr))', gap: '40px' }}>
        ...
        <div>
          ...
          <ul className="footer-links">
            <li style={{ display: 'flex', gap: '8px', alignItems: 'flex-start' }}>
              ...
              <span style={{ lineHeight: '1.6', color: 'rgba(255,255,255,0.85)' }}>Komplek Masjid Agung Al Azhar<br />Jl. Sisingamangaraja, Kebayoran Baru<br />Jakarta Selatan, 12110</span>
            </li>
            <li style={{ display: 'flex', gap: '8px', alignItems: 'center', marginTop: '8px' }}>
              <Mail size={18} color="var(--secondary-color)" />
              <span style={{ color: 'rgba(255,255,255,0.85)' }}>fwpsekretariat@gmail.com</span>
            </li>
            <li style={{ display: 'flex', gap: '8px', alignItems: 'center', marginTop: '8px' }}>
              <Phone size={18} color="var(--secondary-color)" />
              <span style={{ color: 'rgba(255,255,255,0.85)' }}>0813 8966 7055</span>
            </li>
          </ul>
        </div>
        ...
        <div>
          ...
          <p style={{ color: 'rgba(255,255,255,0.85)', lineHeight: '1.6' }}>Dukung pertumbuhan ekonomi umat melalui wakaf produktif bersama Lembaga Nazhir terpercaya di seluruh Indonesia.</p>
          ...
          <div style={{ marginTop: '24px', display: 'flex', gap: '12px', alignItems: 'center' }}>
            <a
              ...
              target="_blank"
              rel="noreferrer"
              style={{ display: 'flex', alignItems: 'center', gap: '6px', color: 'rgba(255,255,255,0.9)', fontSize: '0.9rem', textDecoration: 'none' }}
            >
      ...
      <div className="footer-bottom" style={{ marginTop: '48px', padding: '24px 0', borderTop: '1px solid rgba(255,255,255,0.15)', textAlign: 'center', fontSize: '0.9rem', color: 'rgba(255,255,255,0.8)' }}>
